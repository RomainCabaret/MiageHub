...
public class SemaineHelper {
    ...
    private static final String SWAP_WEEK_ID = "IE.Identite.collection._3.Instances[1].Instances[3]_j_";
    /**
     * Renvoie l'ID du bouton semaine à partir d'une date donnée.
     * Exemple : si date = 8 sept 2024 => retourne "IE.Identite.collection._2.Instances[1].Instances[3]_j_2"
     */
